...
void sprd_pbint_7s_reset_enable(void)
{	
    u32 val = 0;	
    val = sci_adi_read(ANA_REG_GLB_POR_7S_CTRL);	
    val &= ~BIT_PBINT_7S_RST_DISABLE;	
    sci_adi_write(ANA_REG_GLB_POR_7S_CTRL, val, 0xffff);
}
